...
interface DeviceTableFooterProps {
  totalPages: number;
  setCurrentPage: (page: number) => void;
  currentPage: number;
}

const DeviceTableFooter: React.FC<DeviceTableFooterProps> = ({
  totalPages,
  currentPage,
  setCurrentPage,
}) => {
  ...
  return (
    <div className="flex items-center justify-center gap-4 bg-white rounded-lg shadow-lg shadow-black p-2">
